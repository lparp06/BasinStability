...
module load CUDA/11.1.1-GCC-10.2.0   # replace with CUDA/12.x if available
...
# Point JAX/XLA at the CUDA installation provided by the loaded module
export XLA_FLAGS="--xla_gpu_cuda_data_dir=${CUDA_ROOT:-${EBROOTCUDA}}"
# Restrict JAX to the GPU(s) allocated by SLURM
