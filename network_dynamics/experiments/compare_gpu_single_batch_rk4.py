"""
Compare single-trajectory and batched JAX RK4 integration.

Run from project root:

    python -m network_dynamics.experiments.compare_gpu_single_batch_rk4
"""
...
from network_dynamics.gpu.integration import integrate_rk4_batch_jax, integrate_rk4_jax


def make_initial_condition(seed=82):
...
def main():
    ...
    single_sol, _ = integrate_rk4_jax(
        G=graph,
    ...
    batch_sol, _ = integrate_rk4_batch_jax(
        G=graph,
